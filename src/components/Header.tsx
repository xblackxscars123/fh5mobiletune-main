    ...
    <header className="relative py-6 sm:py-8 md:py-10 mb-6 sm:mb-8 overflow-hidden">
      ...
      <div className="relative z-10 text-center space-y-4 md:space-y-6">
        ...
        <div className="flex items-center justify-center gap-3 sm:gap-4 pt-4 flex-wrap">
          <Link 
            to="/community" 
            className="relative flex items-center gap-2 px-4 py-2.5 rounded-lg bg-neon-pink/10 hover:bg-neon-pink/20 border border-neon-pink/40 hover:border-neon-pink/60 transition-all text-sm font-medium text-neon-pink shadow-[0_0_15px_hsl(var(--neon-pink)/0.2)] hover:shadow-[0_0_25px_hsl(var(--neon-pink)/0.4)] backdrop-blur-sm circuit-button overflow-hidden"
          >
